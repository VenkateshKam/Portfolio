...
const AboutMe = () => {
  ...
  const ImageSequence = useMemo(() => (
    <div 
      ...
      className="relative w-40 h-64 md:w-56 md:h-[26rem] overflow-hidden rounded-2xl"
      style={{
    ...
    <section id="about-me" className="min-h-[400vh] bg-black relative">
      <div className="sticky top-0 h-screen w-full flex flex-col overflow-hidden">
        ...
        <div className="flex flex-col px-10 md:px-20 lg:px-28 pt-10">
          ...
          <h2 className="mt-4 sm:mt-16 text-2xl md:text-3xl lg:text-[2.25rem] font-bold leading-[1.2] tracking-tight text-white/25 w-full max-w-3xl">
        ...
        <div className="flex-1 flex items-center justify-center py-4 md:py-10">
          <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row h-full px-4 items-center gap-6 md:gap-20">

            {/* Left - Animation with Fade effect - Shifted Further Left */}
            <div 
              className="w-full md:w-1/2 h-auto md:h-full relative flex items-center justify-center md:justify-start md:pl-0 transition-opacity duration-500"
            ...
            {/* Right - Text blocks */}
            <div className="w-full md:w-1/2 flex-1 md:h-full flex flex-col justify-center relative z-30 mt-2 md:mt-0">
              ...
              {[
                ...
                >
                  <div className="py-4 sm:py-8 md:py-10 relative border-y border-white/10 mx-4 sm:mx-0">
